      ...
      <div className="view__product">
        ...
        <div className="view__product__container">
          <div className="view__product__container__tittle">
            <h2>
              Reparación de {product.part} para {product.brand} {product.line}{" "}
              {product.model}{" "}
            </h2>
            <div className="view__product__container__tittle-extra">
              ...
              <p>
                <img src={Check} alt="" /> Garantía de 6 meses!
              </p>
            </div>
          </div>
          ...
          <div className="view__product__container__benefits">
            ...
            <div className="view__product__container__benefits-item">
              <img src={World} alt="" />
              <span>Ahorro de residuos que dañan el ambiente</span>
            </div>
          </div>
          <div className="view__product__container__workshop">
            <h3>
              <img src={Check} alt="" />
              Garantía de satisfacción de 24 horas despues del servicio
            </h3>
            <p>Sabemos que nuestro servicio te encantara, por ello protegemos tu inversion con una garantía de satisfaccion de 24 horas por si algo no es lo que esperabas</p>
          ...
          <div className="view__product__container__reviews">
            ...
            {product.reviews.lenght === 0 && (
              <div>Aún no hay reseñas, añade una!</div>
            )}
