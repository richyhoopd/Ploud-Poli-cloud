      ...
      {loading ? (
        ...
        <form className="product__edit__form" onSubmit={submitHandler}>
          ...
          <div className="product__edit__form-input">
            ...
            <select id="Linea" value={category}
          ...
          <option value="Seleccione una opcion">Seleccione una opcion</option>
            ...
            <option value="Componentes">Otros</option>
         </select>
          </div>
          <div className="product__edit__form-input">
            <label>Marca</label>
          ...
          <div className="product__edit__form-input">
            <label id="label__img" htmlFor="image">Subir imagen</label>
            <input id="image" type="file" onChange={uploadFileHandler} />
            {loadingUpload && <div>cargando...</div>}
          </div>
          <div className="product__edit__form-input">
            <label id="label__img" htmlFor="image__extra">Subir imagen adicional</label>
            <input id="image__extra" type="file" onChange={(e) => uploadFileHandler(e, true)} />
            {loadingUpload && <div>cargando...</div>}
          </div>
          <div className="imagen__text">
            <label className="popo">Sin imagenes adicionales</label>
            {images.length === 0 && <span>Sin imagen</span>}
              {images.map((x) => (
                <div key={x}>
                  <span>{x}</span>
