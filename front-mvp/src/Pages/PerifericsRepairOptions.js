...
export default function PcRepairOptions() {
     ...
     const submitHandler = (e) => {
       ...
       if (category !== "Perifericos") {
         localStorage.setItem("category", "Perifericos");
       }
  ...
  return (
    ...
    <div className="form__problem">
      <Nav />
      <FormTop
        tittle="Por el momento solo puedes cotizar reparaciones de periféricos vía WhatsApp"
        parragraph="¡Escríbenos un mensaje y con gusto te atenderemos!"
        current2="form__top-progress-bar-current"
      />
      <center><img src={Peripheral} alt="periferico" style={{marginTop: '40px'}}/></center>
