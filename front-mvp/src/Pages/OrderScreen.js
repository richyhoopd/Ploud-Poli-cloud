            ...
            <div>
              {isPending ? (
                ...
                <p className="add__text">
                  Prepara la cantidad en efectivo justa, por favor.
                </p>
              )}
              {loadingPay && <div></div>}
            </div>
            ...
            !order.isDelivered && (
              <div className="button__tracking">
                ...
                <button onClick={fixOrderHandler}>
                  Marcar orden como en proceso de reparación
                </button>
              </div>
            )}
          {userInfo.isAdmin &&
            ...
            !order.isDelivered && (
              <div className="button__tracking">
                ...
                <button onClick={waybackOrderHandler}>
                  Marcar la orden como regresando a casa
                </button>
              </div>
            )}
          {userInfo.isAdmin &&
        ...
        <div className="tracking__steps">
          <div className="tracking__steps-step">
            ...
            <div className="tracking__steps-step-text">
              <h3>En camino</h3>
              <p>El repartido recogerá tu dispositivo</p>
            </div>
          </div>
          <div className="tracking__steps-step">
            {order.isPicked ? (
          ...
          <div className="tracking__steps-step">
            ...
            <div className="tracking__steps-step-text">
              <h3>Taller</h3>
              <p>El dispositivo está siendo reparado</p>
            </div>
          </div>
          <div className="tracking__steps-step">
            {order.isOnItsWayBack ? (
            ...
            <div className="tracking__steps-step-text">
              ...
              <p>Tu dispositivo está en camino de regreso</p>
            </div>
          </div>
          <div className="tracking__steps-step">
            {order.isDelivered ? (
