      ...
      <div className="nav__menu">
        ...
        {userInfo ? (
          <div className="nav__menu__options">
            ...
            <a href="https://api.whatsapp.com/send?phone=5213339485139&text=%C2%A1Hola!%20Quisiera%20saber%20m%C3%A1s%20acerca%20de%20como%20reparar%20con%20chipsi." className="nav__menu__options__option" id="Escribenos__nav">
        ...
        {userInfo && userInfo.isAdmin && (
          <div className="nav__menu__options">
            <strong className="admin__el__cacas">ADMIN DASHBOARD</strong>
        ...
        {userInfo && userInfo.isSeller && (
          <div className="nav__menu__options">
            <strong className="admin__el__cacas">VENDEDOR DASHBOARD</strong>
